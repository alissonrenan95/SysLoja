...
CREATE TABLE Estoque (
  ...
  Produto_Categoria_produto_id INTEGER UNSIGNED NOT NULL,
  Produto_id INTEGER UNSIGNED NOT NULL,
  valor FLOAT NOT NULL,
  disponivel_venda BOOL NOT NULL,
  quantidade INTEGER UNSIGNED NOT NULL,
  PRIMARY KEY(cod_barra),
  INDEX Estoque_FKIndex1(Produto_id, Produto_Categoria_produto_id)
)
TYPE=InnoDB;

CREATE TABLE Estoque_venda (
  Estoque_cod_barra BIGINT NOT NULL,
  Venda_id INTEGER UNSIGNED NOT NULL,
  quantidade INTEGER UNSIGNED NOT NULL,
  valor_unitario FLOAT NOT NULL,
  PRIMARY KEY(Estoque_cod_barra, Venda_id),
  INDEX Estoque_has_Venda_FKIndex1(Estoque_cod_barra),
  INDEX Estoque_has_Venda_FKIndex2(Venda_id)
)
TYPE=InnoDB;
...
CREATE TABLE Fornecimento_estoque (
  Fornecimento_id INTEGER UNSIGNED NOT NULL,
  Estoque_cod_barra BIGINT NOT NULL,
  quantidade INTEGER UNSIGNED NOT NULL,
  valor_unitario FLOAT NOT NULL,
  PRIMARY KEY(Fornecimento_id, Estoque_cod_barra),
  INDEX Fornecimento_has_Estoque_FKIndex1(Fornecimento_id),
  INDEX Fornecimento_has_Estoque_FKIndex2(Estoque_cod_barra)
)
TYPE=InnoDB;
...
CREATE TABLE Produto (
  ...
  PRIMARY KEY(id, Categoria_produto_id),
